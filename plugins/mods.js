...
ruok({ nomCom: "block", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
ruok({ nomCom: "deblock", categorie: "Mods" }, async (dest, zk, commandeOptions) => {
...
ruok({ nomCom: "purge", categorie: "Groupe", reaction: "📣" }, async (dest, zk, commandeOptions) => {
