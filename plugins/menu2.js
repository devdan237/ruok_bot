...
const { ruok } = require(__dirname + "/../framework/ruok");
...
ruok({ nomCom: "menu", categorie: "Général" }, async (dest, zk, commandeOptions) => {
 ...
 async  function execute(dest,zok,commandeOptions?)
  {
    ...
    var link = "https://files.catbox.moe/y3a923.jpg"
